    ...
    translation: {
      ...
      dashboard: {
        meal_plan: {
          ...
          eaten: 'Eaten',
          not_eaten: 'Not Eaten',
          plan_not_found: "Today's plan not found",
          weekly_not_found: 'Weekly plan not found',
          history_empty: 'No history',
          feedback_prompt: 'How was this plan?',
        },
        health_log: {
          title: 'Health Log',
          new_entry: 'New Entry',
          ...
          trends: 'Trends',
          no_logs: 'No logs yet',
          guidelines: 'Your Guidelines',
          latest_reading: 'Latest Reading',
        },
        report: {
          title: 'Nutrition Report',
          subtitle: 'NDG 2025 Based Analysis',
          daily_targets: 'Daily Nutrition Targets',
          bmi: 'BMI',
          ideal_weight: 'Ideal Weight',
          water: 'Water Target',
          macro_split: 'Macro Distribution (NDG 2025)',
          conditions: 'Dietary Guidelines for Your Conditions',
          email_report: 'Weekly Report via Email',
          email_desc: 'Your weekly AI progress summary will be emailed',
          send: 'Send',
          setup_profile: 'Set up your profile first',
        },
        foods: {
          title: 'Food Database',
          search: 'Search foods...',
    ...
    translation: {
      ...
      dashboard: {
        meal_plan: {
          ...
          save: 'সেভ করুন',
          cancel: 'বাতিল',
          add_food: 'নতুন খাবার যোগ করুন',
          search_food: 'খাবারের নাম খুঁজুন...',
          no_food_found: 'কোনো খাবার পাওয়া যায়নি',
          eaten: 'খাওয়া হয়েছে',
          not_eaten: 'খাওয়া হয়নি',
          plan_not_found: 'আজকের প্ল্যান পাওয়া যায়নি',
          weekly_not_found: 'সাপ্তাহিক প্ল্যান পাওয়া যায়নি',
          history_empty: 'কোনো ইতিহাস নেই',
          feedback_prompt: 'এই প্ল্যান কেমন লাগলো?',
        },
        health_log: {
          title: 'স্বাস্থ্য লগ',
          new_entry: 'নতুন এন্ট্রি',
          weight: 'ওজন (কেজি)',
          blood_sugar: 'রক্তের শর্করা (mmol/L)',
          ...
          trends: 'ট্রেন্ড',
          no_logs: 'কোনো লগ নেই',
          guidelines: 'আপনার নির্দেশিকা',
          latest_reading: 'সর্বশেষ রিডিং',
        },
        report: {
          title: 'পুষ্টি রিপোর্ট',
          subtitle: 'NDG 2025 ভিত্তিক পুষ্টি বিশ্লেষণ',
          daily_targets: 'দৈনিক পুষ্টি লক্ষ্য',
          bmi: 'BMI',
          ideal_weight: 'আদর্শ ওজন',
          water: 'পানির লক্ষ্য',
          macro_split: 'ম্যাক্রো বিভাজন (NDG 2025)',
          conditions: 'আপনার অবস্থার জন্য খাদ্য নির্দেশিকা',
          email_report: 'সাপ্তাহিক রিপোর্ট ইমেইলে পান',
          email_desc: 'আপনার সাপ্তাহিক অগ্রগতির AI সারসংক্ষেপ ইমেইলে পাঠানো হবে',
          send: 'পাঠান',
